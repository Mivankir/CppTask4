...
// MyDictApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMyDictAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMyDictAppApp

CMyDictAppApp::CMyDictAppApp()
{
...
// Единственный объект CMyDictAppApp

CMyDictAppApp theApp;


// Инициализация CMyDictAppApp

BOOL CMyDictAppApp::InitInstance()
{
